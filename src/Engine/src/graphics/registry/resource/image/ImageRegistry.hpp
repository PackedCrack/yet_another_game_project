...
struct ViewDescriptionHasher
{
    size_t operator()(const ViewDescription& desc) const noexcept
    {
        ...
        value ^= Hasher{}(static_cast<std::uint64_t>(desc.type))                    + 0x9e3779b97f4a7c15ull + (value << 6) + (value >> 2);
        value ^= Hasher{}(static_cast<std::uint64_t>(desc.format))                  + 0x9e3779b97f4a7c15ull + (value << 6) + (value >> 2);
        value ^= Hasher{}(static_cast<std::uint64_t>(desc.range.aspectMask))        + 0x9e3779b97f4a7c15ull + (value << 6) + (value >> 2);
        value ^= Hasher{}(static_cast<std::uint64_t>(desc.range.baseMipLevel))      + 0x9e3779b97f4a7c15ull + (value << 6) + (value >> 2);
        value ^= Hasher{}(static_cast<std::uint64_t>(desc.range.levelCount))        + 0x9e3779b97f4a7c15ull + (value << 6) + (value >> 2);
        value ^= Hasher{}(static_cast<std::uint64_t>(desc.range.baseArrayLayer))    + 0x9e3779b97f4a7c15ull + (value << 6) + (value >> 2);
        value ^= Hasher{}(static_cast<std::uint64_t>(desc.range.layerCount))        + 0x9e3779b97f4a7c15ull + (value << 6) + (value >> 2);
