...
{}
ShaderHandle ResourceRegistry::shader(const std::filesystem::path& filepath)
{
...
std::shared_ptr<ShaderSlot> ResourceRegistry::shader_slot(const std::filesystem::path& filepath)
{
