...
public:
    void execute(const FrameContext& frameContext, const descriptors::Indirect& indirect, std::int32_t instanceCount) const;
private:
    void bind_descriptors(const FrameContext& frameContext, const descriptors::Indirect& indirect) const;
